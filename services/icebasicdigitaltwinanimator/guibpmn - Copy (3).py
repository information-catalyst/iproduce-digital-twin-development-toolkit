...
def commandProcessor(payloadObject):
	...
	completed, success, timetaken = runtask(task,lastSuccessful)
	print(task['Name'])
	print(completed)
	print(success)
	print(timetaken)
	...
	if completed==True and success==True :
		# successful task
		locallable.config(bg="SystemButtonFace")
...
def runtask(task, lastSuccessful):
...
def clearSimulation():
	...
	runButton.config(bg="SystemButtonFace")
...
class Application(Tk):
    def createWidgets(self):
    	...
    	self.filemenu.add_command(label="Save", command=saveFileXML)
...
runButton = Button(bottomframe, text="RUN", command = runSimulation)
runButton.pack( side = LEFT)

clearButton = Button(bottomframe, text="Clear", command = clearSimulation)
clearButton.pack( side = LEFT )

bluebutton = Button(bottomframe, text="RED", fg="red", command = boomButton_click)
bluebutton.pack( side = LEFT )


saveButton = Button(bottomframe, text="SaveAs", command=saveFileXML)
