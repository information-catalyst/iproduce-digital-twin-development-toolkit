...
String parts = "SELECT * FROM formsubmit.users;";
String retValue = "";
 ResultSet rs = st.executeQuery(parts); 
 while(rs.next())
 {
    retValue += rs.getString("ID")+",";
    retValue += rs.getString("longitude")+",";
    retValue += rs.getString("latitude")+",";
    retValue += rs.getString("description")+",";
    retValue += rs.getString("link")+",";
